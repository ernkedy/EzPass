...
class MainWindow(QObject):
    ...
    def addPassword(self, password):
        passwordlist = editpass(jsons=passwordlist, decision="add_password", data=json.dumps({"amogus":"sus"}))
        savepass(passwordlist["file_name"], passwordlist, encpassword, encpassword)
